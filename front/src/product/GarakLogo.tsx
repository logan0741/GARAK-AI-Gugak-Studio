...
const GARAK_LOGO_PATHS = [
  ...
  'M176.591 1.93457H167.657L148.777 26.5871L167.657 51.6394H176.591L157.174 26.5871L176.591 1.93457Z',
  'M67.0477 1.9367H65.236L48.2054 26.989H20.4792V33.9112H44.6069C41.3207 42.2328 34.7484 46.781 26.5642 46.781C16.1434 46.781 7.54693 37.5472 7.54693 26.6392C7.54693 16.4308 16.2184 6.92216 26.2893 6.92216C32.0245 6.92216 36.4352 8.94637 40.8334 13.9818H49.6423C44.3945 4.6856 35.8604 0 25.9395 0C12.8573 0 0 10.7706 0 27.5513C0 41.5331 11.9576 53.7032 25.9395 53.7032C37.7222 53.7032 48.9426 46.7435 52.2413 33.9612L52.2788 33.9112H67.0477V51.6415H74.3073V1.92419H67.0477V1.9367ZM67.0477 26.989H56.9893L67.0477 12.1826V26.989Z',
] as const;

export type GarakLogoVariant = 'red' | 'amber' | 'light';

type GarakLogoProps = {
  variant?: GarakLogoVariant;
  width?: number;
  height?: number;
