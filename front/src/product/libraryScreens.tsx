...
export function LibraryContent({
  ...
  const playerProgressFraction = getMyLibraryPlayerViewModel(state).progressFraction;
      ...
      <View style={[styles.myHeroDeck, isEmptyLibrary ? styles.myHeroDeckEmpty : undefined]}>
        {model.heroCards.map((card, index) => (
          <MyLibraryHeroCardView
            ...
            card={card}
            index={index}
            progressFraction={playerProgressFraction}
    ...
    >
      ...
      <View style={styles.playingPanel}>
        ...
        <View style={styles.playingControls}>
          <Pressable
            accessibilityLabel={player.isFavorite ? '즐겨찾기 해제' : '즐겨찾기'}
            accessibilityRole="button"
            accessibilityState={{ disabled: playerActions.favoriteAction === undefined, selected: player.isFavorite }}
        ...
        <>
          ...
          <View style={styles.myHeroControlBlock}>
            <View style={styles.myHeroProgress}>
              <View style={[styles.myHeroProgressFill, { width: `${Math.round(progressFraction * 100)}%` }]} />
            </View>
        ...
        {row.active ? (
          <>
            ...
            <View style={[styles.playlistProgress, activeMeta !== undefined ? styles.playlistProgressWithMeta : undefined]}>
              <View style={[styles.playlistProgressFill, { width: `${Math.round(progressFraction * 100)}%` }]} />
            </View>
          </>
        ) : (
