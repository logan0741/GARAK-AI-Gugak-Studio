...
import { runD2DemoAndroidRecordingEvidenceCommand } from '../src/qa/d2DemoAndroidRecordingEvidenceCommand';

process.exitCode = runD2DemoAndroidRecordingEvidenceCommand({
  argv: withDefaultAdbPath(process.argv.slice(2)),
  workingDirectory: process.cwd(),
  getCollectedAt: () => new Date().toISOString(),
