...
| --- | --- | --- | --- |
| 실제 Android/iOS 기기 시각 QA | 현재 세션에서는 실제 기기 화면, 시스템 폰트, safe area, 터치 영역을 직접 확인할 수 없다. | dev build가 설치된 실제 기기와 화면 캡처 | S01, S04, S05, S07, S18의 텍스트 겹침과 터치 대상 44px 이상 여부를 확인한다. |
