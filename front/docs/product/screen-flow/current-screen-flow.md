...
| S05 | 악기 자유연주 | 선택한 악기를 화면 중심에 두고 직접 연주하고 녹음한다. 세세한 레이어/박자 편집은 담당하지 않는다. | 녹음, 완료, 장단, 레이어 편집 | S01, S03, S04A | S07, S10 | 필수 |
...
| S08 | 트랙 추가 | 작업에 추가할 트랙 타입을 먼저 고르고, 악기 연주 추가를 선택한 경우 추가 악기를 고른다. | 악기 연주 추가, 장단/반주 추가, 가져오기, 취소 | S07 | S09, S10, S07 | 필수 |
...
- 트랙 추가 -> S08 `트랙 추가`
- S08에서 장단/반주 추가 선택 -> S10 `장단 및 반주 패널`
