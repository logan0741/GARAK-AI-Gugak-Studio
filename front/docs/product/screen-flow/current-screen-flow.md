...
flowchart TD
    ...
    PracticeResult --> SharePrepare["공유 준비"]
...
| S07 | 트랙/레이어 편집 | 여러 트랙과 반주를 박자 그리드 위에 레이어로 쌓고 간단히 편집한다. | 트랙 추가, 위치 조정, 볼륨, mute/solo, 저장 | S06, S18 | S08, S10, S18 | 필수 |
...
| S11 | 반주 적용 후 트랙/레이어 편집 | AI 반주가 트랙으로 추가된 상태를 확인한다. | 저장, 다시 조정 | S10 | S07, S18 | 필수 |
