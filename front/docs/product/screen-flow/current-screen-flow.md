...
| S04 | 악기 선택 및 조율 설정 | 자유창작 모드에서 가야금, 장구, 대금 중 연주할 악기를 고르고 필요한 조율/터치/잔향 설정을 확인한다. | 악기 선택, 설정 저장하기, Next | S01, S05 | S05 또는 이전 화면 | 필수 |
...
- 자유창작 모드의 S04 악기 선택 화면에서 잠긴 악기를 어떻게 표시할지 정해야 한다.
